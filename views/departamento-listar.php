...
<html lang="pt-br">
	...
	<body>
        <header>
            <div class="header-pagina">Departamentos</div>
        </header>

        <section class="conteudo">

            <div class="cadastrar">
                <a href="departamento-cadastro.php">Cadastrar</a>
            </div>        
            ...
            <table class="listagem">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="../controllers/departamento/departamento-excluir.php?id=<?php echo $item['id']?>"><img src="../assets/excluir.png" alt="Excluir" title="Excluir" id="btnExcluir"></a></td>
                    </tr>			
                    <?php
                            }
                        }
