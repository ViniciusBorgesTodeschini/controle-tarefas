            ...
            <table class="listagem">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="../controllers/atendimento/atendimento-assunto/atendimento-assunto-excluir.php?id=<?php echo $item['id']?>"><img src="../assets/excluir.png" alt="Excluir" title="Excluir"></a></td>                    
                    </tr>			
                    <?php
                            }
                        }
