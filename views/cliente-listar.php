...
<html lang="pt-br">
	...
	<body>
        <header>
            <div class="header-pagina">Clientes</div>
        </header>

        <section class="conteudo">

            <div class="cadastrar">
                <a href="cliente-cadastro.php">Cadastrar</a>
            </div>
            ...
            <table class="listagem">
                ...
                <tbody>
                    <?php
                        ...
                        $sql = "SELECT * FROM pessoa WHERE pessoa.cliente = 'S' ORDER BY id";
                    ...
                    <tr>
                        ...
                        <td><a href="../controllers/cliente/cliente-excluir.php?id=<?php echo $item['id']?>"><img src="../assets/excluir.png" alt="Excluir" title="Excluir"></a></td>                    
                    </tr>			
                    <?php
                            }
                        }
